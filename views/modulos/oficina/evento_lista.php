...
<!-- DataTables -->
<script defer src="<?= SERVERURL ?>views/plugins/datatables/jquery.dataTables.js"></script>
<script defer src="<?= SERVERURL ?>views/plugins/datatables/dataTables.bootstrap4.js"></script>