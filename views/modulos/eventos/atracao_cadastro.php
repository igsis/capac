        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal formulario-ajax" method="POST" action="<?=SERVERURL?>ajax/atracaoAjax.php" role="form" data-form="<?= ($atracao) ? "update" : "save" ?>">
                        <input type="hidden" name="_method" value="<?= ($atracao) ? "editarAtracao" : "cadastrarAtracao" ?>">
                        <?php if ($atracao): ?>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control" id="nome_atracao" name="nome_atracao" placeholder="Digite o nome da Atração" maxlength="240" value="<?=$atracao->nome_atracao ?? ""?>" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" name="ficha_tecnica" id="ficha_tecnica" rows="8" required><?= $atracao->ficha_tecnica ?? "" ?></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" name="integrantes" id="integrantes" rows="8" required><?= $atracao->integrantes ?? "" ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="quantidade_apresentacao"
                                           name="quantidade_apresentacao" maxlength="2" value="<?= $atracao->quantidade_apresentacao ?? "" ?>" required>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="valor_individual" name="valor_individual"
                                           class="form-control" value="<?= $atracao->valor_individual ?? "" ?>" required
