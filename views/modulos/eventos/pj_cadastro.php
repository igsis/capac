        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal formulario-ajax" method="POST" action="<?= SERVERURL ?>ajax/<?= ($id) ? "pessoaJuridicaAjax.php" : "pedidoJuridicaAjax.php" ?>" role="form" data-form="<?= ($id) ? "update" : "save" ?>">
