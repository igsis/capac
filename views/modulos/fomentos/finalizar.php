...
//Representante
    ...
    $validacaoProjeto = $projetoObj->validaProjeto($idProj);
    ?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <?php
            if (isset($validacaoProjeto)) {
                ?>
                <div class="row erro-validacao">
                    <?php foreach ($validacaoProjeto as $titulo => $erros): ?>
                        <div class="col-md-4">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!-- Horizontal Form -->
                    <div class="row erro-validacao justify-content-center mt-5">
                        <div class="col-md-8">
                            <div class="card bg-danger">
                                <div class="card-body">
                                    <h3 class="card-title"><i class="fa fa-exclamation mr-3"></i><strong>Por favor Cadastre um projeto para pode finalizar </strong></h3>
                                </div>
                                <!-- /.card-body -->
                            </div>
                        </div>
