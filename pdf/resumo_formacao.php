...
$pdf->SetFont('Arial', 'B', $f);
$pdf->Cell(11, $l, utf8_decode("CCM:"), 0, 0, 'L');
$pdf->SetFont('Arial', '', $f);
$pdf->Cell(19, $l, utf8_decode($pf['ccm']), 0, 1, 'L');
...
$pdf->SetFont('Arial', '', $f);
$pdf->Cell(50, $l, utf8_decode($pfDados['genero']), 0, 0, 'L');
$pdf->SetFont('Arial', 'B', $f);
$pdf->Cell(13, $l, utf8_decode("Trans:"), 0, 0, 'L');
$pdf->SetFont('Arial', '', $f);
$pdf->Cell(20, $l, utf8_decode($trans), 0, 0, 'L');
$pdf->SetFont('Arial', 'B', $f);
